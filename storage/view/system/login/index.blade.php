    ...
    <div class="lyear-login">
        <div class="login-center">
            <div class="login-header text-center">
                <a href="javascript:void(0);"> <img alt="light year admin" src="{{$app_manager_logo}}"> </a>
            </div>
            <form class="form" onsubmit="return false;">
                ...
                <div class="form-group has-feedback feedback-left row">
                    ...
                    <div class="col-xs-5">
                        <img src="/system/login/captchas?t=111" class="pull-right" id="captcha" style="cursor: pointer;" onclick="this.src='/system/login/captchas?t'+'='+Math.random();" title="点击刷新" alt="captcha">
                    </div>
                </div>
