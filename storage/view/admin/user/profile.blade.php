                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="edit-avatar">
                            <img @if($user['photo'] != '') src="{{$user['photo']}}" @else src="/images/users/avatar.jpg" @endif class="img-avatar">
                            <div class="avatar-divider"></div>
                            <div class="edit-avatar-content">
                                <button class="btn btn-default uplo">修改头像</button>
                                <input id="input-ke-2" name="file" type="file" style="display: none">
                                @if($user['photo'] != '')
                                    <input type="hidden" class="img" id="img" value="{{$user['photo']}}" name="img">
                                @else
