                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="edit-avatar">
                            <img @if($uinfo['photo'] != '') src="{{$uinfo['photo']}}" @else src="/images/users/avatar.jpg" @endif class="img-avatar">
                            <div class="avatar-divider"></div>
                            <div class="edit-avatar-content">
                                <button class="btn btn-default uplo">修改头像</button>
                                <input id="input-ke-2" name="file" type="file" style="display: none">
                                @if($uinfo['photo'] != '')
                                    <input type="hidden" class="img" id="img" value="{{$uinfo['photo']}}" name="img">
                                @else
                        ...
                        <form onsubmit="return false;" class="site-form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="输入您的昵称" value="{{ $list['name'] }}">
                            </div>
